...
urlS = url_generator('spectra', 'LP_Turbine', 'MAD31CY005', 'AM1', 2019, 4,
                                   11, 18, 25, 54)
urlW = url_generator('waves', 'LP_Turbine', 'MAD31CY005', 'AM1', 2019, 4,
                                   11, 18, 25, 54)
...
plt.plot(freq_calculado, espectro_calculado, label='Espectro calculado (FFT)', color='blue')

# Espectro original (de la API)
plt.plot(freq_original, espectro_original, label='Espectro original', color='red', linestyle='--')
