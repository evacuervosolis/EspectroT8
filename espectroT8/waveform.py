...
waveform = decode_and_convert_to_float(response.json()["data"])  # Esto debería ser una lista de valores numéricos
#--------------------------------------------------------------------------------------------------------------------------
...
adjusted_waveform = waveform * factor #multiplicamos por el factor dado en la API T8
#--------------------------------------------------------------------------------------------------------------------------
...
# Normalizamos el espectro para que sea más visual
